 ...
 <link rel="stylesheet" href="fontawesome/css/styleproduct.css">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Telusuri petualangan baru dalam halaman-halaman buku.</h1>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            ?>
            <div class="col mb-5">
                <div class="card product-item product-cart" style="height: 590px;">
                    <!-- Product image-->
